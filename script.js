class Dice {
    ...
    roll() {
        ...
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = 'url("i1.jpg")';
        }
        if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = 'url("i2.jpg")';
        }
        if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = 'url("i3.jpg")';
        }
        if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = 'url("i4.jpg")';
        }
        if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = 'url("i5.png")';
        }
        if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = 'url("i6.jpg")';
        }
        if (this.type == 1) {
            if (this.r.checker()) {
